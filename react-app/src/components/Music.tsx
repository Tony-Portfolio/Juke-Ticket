...
function Music() {
    ...
    const [results, setResults] = useState(MusicData.items);
                        ...
                        <div className="md:text-left text-center">
                            ...
                            <div className="w-full">
                                ...
                                <div className="flex gap-2 mt-4">
                                    ...
                                    <input type="range" className="w-full" name="volume" id="" min="0" max="100" onChange={(v) => { player.setVolume(v.target.value); setVideoVolume(v.target.value) }} />
                                </div>
                            </div>
                        </div>
                    </div>
